...
export const intlAuthenticationSignIn = (): string => { return intl.get(AUTHENTICATION_SIGNIN); }
export const intlAuthenticationSignOut = (): string => { return intl.get(AUTHENTICATION_SIGNOUT); }